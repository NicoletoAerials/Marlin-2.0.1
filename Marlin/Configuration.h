...
#define STRING_CONFIG_H_AUTHOR "(NCP, Nicoleto Aerials)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Nicoleto Aerials"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 199, 198, 799, 273}//{ 199.3024, 198.3143, 799.2056, 273.4200 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 20, 25 } //{ 500, 500, 20, 50 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -49.8, -9, 0 }
...
#define Z_PROBE_LOW_POINT          -1 // -2 Farthest distance below the trigger-point to go before stopping
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS), (Y_MIN_POS), 30 }
