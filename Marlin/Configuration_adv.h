...
//
  ...
  #define BOARD_MAXTEMP          70  // (°C)
    ...
    #define TEMP_BOARD_PIN P1_30      // Board temp sensor pin, if not set in pins file.
  #endif
#endif
...
#define Z_STEPPER_AUTO_ALIGN
   ...
   */
  //#define Z_STEPPER_ALIGN_XY { {  60, 126 }, { 260,  126 }, }
...
// LCD Print Progress options, multiple can be rotated depending on screen layout
   ...
   * point in the file.
   */
  //#define POWER_LOSS_RECOVERY NCP
  #if ENABLED(POWER_LOSS_RECOVERY)
    #define PLR_ENABLED_DEFAULT   false // Power Loss Recovery enabled by default. (Set with 'M413 Sn' & M500)
    #define BACKUP_POWER_SUPPLY       // Backup power / UPS to move the steppers on power loss
    #define POWER_LOSS_ZRAISE       2 // (mm) Z axis raise on resume (on power loss with UPS)
    #define POWER_LOSS_PIN         P1 20 // Pin to detect power loss. Set to -1 to disable default pin on boards without module.
    #define POWER_LOSS_STATE     HIGH // State of pin indicating power loss
    #define POWER_LOSS_PULLUP         // Set pullup / pulldown as appropriate for your sensor
    //#define POWER_LOSS_PULLDOWN
    #define POWER_LOSS_PURGE_LEN   5 // (mm) Length of filament to purge on resume
    #define POWER_LOSS_RETRACT_LEN 4 // (mm) Length of filament to retract on fail. Requires backup power.
